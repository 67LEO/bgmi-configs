...
export default function NewConfig() {
  ...
  return (
    <>
      <Head><title>New Config - BGMI Admin</title></Head>
      <div className="admin-layout">
        <aside className="admin-sidebar">
          <h2>⚙️ BGMI Admin</h2>
          <nav>
            <Link href="/admin/dashboard">📊 Dashboard</Link>
            <Link href="/admin/new" className="active">➕ New Config</Link>
        ...
        <main className="admin-main">
          ...
          <form className="admin-form" onSubmit={handleSubmit}>
            <div className="form-group">
              <label>Title *</label>
              <input name="title" value={form.title} onChange={handleChange} placeholder="e.g. 4 Finger Claw - Zero Recoil" required />
            </div>
            <div className="form-group">
              <label>Description</label>
              <textarea name="description" value={form.description} onChange={handleChange} placeholder="Describe this config, what makes it special..." />
            </div>
            <div className="form-group">
              <label>Image URL</label>
              <input name="image_url" value={form.image_url} onChange={handleChange} placeholder="https://i.imgur.com/example.jpg (optional)" />
            </div>
            <div className="form-group">
